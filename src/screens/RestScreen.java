...
public class RestScreen extends VBox implements Clock {
  private int minutes;
  ...
  public RestScreen (int minutes,Stage stage){
  ...
  private void createScreen (){
    ...
    Label titleLabel = new Label("Descanso");
    ...
    resetButton.setOnAction(event -> {
        ...
        if(minutes==0 && seconds ==0){
          PomodoroScreen rest = new PomodoroScreen(25,stage);
          Scene pomodoroScreen = new Scene(rest, 300, 350);
          stage.setScene(pomodoroScreen);
        }
